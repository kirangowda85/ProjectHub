...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen pt-24 sm:pt-32 pb-16 px-4 flex items-center justify-center">
      {/* Background Decor */}
      <div className="absolute top-1/4 left-1/4 w-64 sm:w-96 h-64 sm:h-96 rounded-full bg-violet-600/5 blur-[100px] pointer-events-none" />
      <div className="absolute bottom-1/4 right-1/4 w-64 sm:w-96 h-64 sm:h-96 rounded-full bg-cyan-600/5 blur-[100px] pointer-events-none" />
        ...
        <div className="glass-card rounded-3xl overflow-hidden border border-white/10 shadow-2xl">
          ...
          <div className="p-8 sm:p-10">
            <div className="text-center mb-8">
              ...
              <p className="text-slate-400 text-sm">Login to access your purchased projects</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <button type="submit" disabled={loading}
                ...
                {loading ? <><Loader2 size={18} className="animate-spin" /> Logging in...</> : <>Login <ArrowRight size={16} /></>}
              </button>
            </form>
